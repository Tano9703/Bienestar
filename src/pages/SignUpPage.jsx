...
const SignUpPage = () => {
  ...
  const handleSSOSignUp = (provider) => {
    toast({
      ...
      description: `Simulando registro con ${provider}. Serás redirigido.`,
      duration: 3000,
    });
    setTimeout(() => navigate('/'), 3000);
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-100 to-gray-200 flex flex-col items-center justify-center p-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2">Únete a nuestra comunidad de aprendizaje.</p>
        </div>
        ...
        <form onSubmit={handleSignUp} className="space-y-6">
          ...
          <div className="flex items-center space-x-2">
            ...
            <Label htmlFor="terms" className="text-sm text-gray-600">
              Acepto los <a href="#" className="text-blue-500 hover:underline">Términos y Condiciones</a>
            </Label>
          </div>
        ...
        <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-3">
          <Button variant="outline" className="w-full flex items-center justify-center py-3" onClick={() => handleSSOSignUp('Google')}>
            <img  alt="Google logo" className="h-5 w-5 mr-2" src="https://images.unsplash.com/photo-1678483789111-3a04c4628bd6" />
            Google
          </Button>
          <Button variant="outline" className="w-full flex items-center justify-center py-3" onClick={() => handleSSOSignUp('Apple')}>
             <img  alt="Apple logo" className="h-5 w-5 mr-2" src="https://images.unsplash.com/photo-1620829868801-8a443f0370f3" />
            Apple
          </Button>
          <Button variant="outline" className="w-full flex items-center justify-center py-3" onClick={() => handleSSOSignUp('Microsoft')}>
        ...
        <p className="mt-8 text-center text-sm text-gray-600">
          ¿Ya tienes una cuenta? <Link to="/signin" className="font-medium text-blue-500 hover:underline">Inicia sesión</Link>
        </p>
      </motion.div>
    </div>
  );
